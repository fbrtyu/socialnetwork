...
const MessageInput = (props: any) => {
    ...
    return (
        <div style={{ display: "flex", flexWrap: "wrap", marginBottom: "0px", marginTop: "auto", background: "#2BB98BFF",
            width: "100%", maxHeight: "200px", paddingTop: "", alignItems: "center", minHeight: "min-content"}}>
            {
                props.editableMessage &&
                <div style={{width:"100%"}}
                    onClick={()=> {
