...
const MessengerPage = observer(() => {
    ...
    function wsSendEcho() {
        ...
        myWs.send(JSON.stringify({ action: 'ECHO', data: text }));
    };
    function wsSendPing() {
        ...
        <div style={{ display: "flex" }}>
            <div style={{ display: 'flex', background: "honeydew", maxWidth: "900px", width: "700px", minHeight: "500px", flexDirection: "column" }}>
                <div style={{ display: "flex", flexDirection: "column-reverse", width: "100%", height: "100%" }}>
                    {
                        dialogMessagges.map(message =>
                            <div key={message.id} style={id === message.sender ? {
                ...
                <div style={{
                    ...
                    <div id='mess' contentEditable={"true"} style={{
                        padding: "3px",
                        borderRadius: "5px",
                        background: "yellow",
                        width: "450px",
                    ...
                    <input type={"button"} onClick={wsSendEcho} value={"X"} style={{ marginRight: "auto", marginLeft: "5px", width: "25px", height: "25px", }} />
                </div>
            </div>
        </div>
    );
